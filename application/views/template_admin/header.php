                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown" aria-label="Open user menu">
                            ...
                            <div class="d-none d-xl-block ps-2">
                                ...
                                <?php $getName =$this->session->userdata('role'); ?>
                               <?php if($getName == 'superadmin'){ ?>
                                     <div class="mt-1 small text-muted">Superadmin</div>
                                     <?php }else if($getName == 'adminkonten') {?>
                                        <div class="mt-1 small text-muted">Admin Konten</div>
                                <?php }?>
                            </div>
                        </a>
        ...
        <header class="navbar-expand-md">
            <div class="collapse navbar-collapse" id="navbar-menu">
                <div class="navbar navbar-light">
                    <div class="container-xl">
                        <?php $getRole =$this->session->userdata('role'); ?>
                                ...
                                <div class="dropdown-menu">
                                    <div class="dropdown-menu-columns">
                                        <div class="dropdown-menu-column">
                                            ...
                                            <a class="dropdown-item <?= $title == 'Manajemen User' ? 'active' : '' ?>" href="<?= base_url('Manajemenuser') ?>">
                                                Manajemen User
                                            </a>
                                        </div>
                                    </div>
                        ...
                        <?php } else if($getRole == 'adminkonten'){ ?>
                            <ul class="navbar-nav">
                            <li class="nav-item <?= $title == 'Dashboard' ? 'active' : '' ?>">
                                <a class="nav-link" href="<?= base_url('Dashboard') ?>">
                                    <span class="nav-link-icon d-md-none d-lg-inline-block">
